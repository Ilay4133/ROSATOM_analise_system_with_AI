...
flow_value_variability=ft.Text(value="235-242 кг/с",color='#ffffff',font_family='Manrope',size=15,
                          weight=ft.FontWeight.W_400)
flow_inf_text_cont_info=ft.Text(value="no data",color='#ffffff',font_family='Manrope',size=30,
                          weight=ft.FontWeight.W_700)
flow_inf_text_cont=ft.Container(content=flow_inf_text_cont_info,width=123,height=40,
                                    border_radius=5, bgcolor='#00A5FF',alignment=ft.Alignment(0,-1))
flow_inf_column=ft.Column(controls=[flow_inf_text,flow_value_variability],spacing=3)
flow_inf_column_cont=ft.Container(content=flow_inf_column,height=151,width=164,
                                  bgcolor=ft.colors.with_opacity(0.5, '#3A4EB1'),
                                  padding=ft.Padding(left=14,bottom=14,right=14,top=14),border_radius=10)

flow_value_variability_cont=ft.Container(content=flow_inf_text_cont,height=151,width=164,
                                         padding=ft.Padding(top=0,bottom=10,right=0,left=10),
                                         alignment=ft.Alignment(-1,1))
...
filter_qu_inf_cont_info=ft.Text(value="no%",color='#ffffff',font_family='Manrope',size=30,
                          weight=ft.FontWeight.W_700)
filter_qu_inf_cont=ft.Container(content=filter_qu_inf_cont_info,width=84,height=40,
                                    border_radius=5, bgcolor='#00A5FF',alignment=ft.Alignment(0,-1))
filter_qu_value_variability_cont=ft.Container(content=filter_qu_inf_cont,height=151,width=164,
                                         padding=ft.Padding(top=0,bottom=10,right=0,left=10),
                                         alignment=ft.Alignment(-1,1))

filter_qu_inf_column=ft.Column(controls=[filter_qu_inf,filter_qu_value_variability],spacing=3)
...
filter_temp_usin_value_variability=ft.Text(value="80-100 °С",color='#ffffff',font_family='Manrope',size=15,
                          weight=ft.FontWeight.W_400)


filter_temp_usin_cont_info=ft.Text(value="100 °С",color='#ffffff',font_family='Manrope',size=30,
                          weight=ft.FontWeight.W_700)

filter_temp_usin_cont=ft.Container(content=filter_temp_usin_cont_info,width=107,height=40,
                                    border_radius=5, bgcolor='#00A5FF',alignment=ft.Alignment(0,-1))
filter_temp_usin_value_variability_cont=ft.Container(content=filter_temp_usin_cont,height=151,width=164,
                                         padding=ft.Padding(top=0,bottom=10,right=0,left=10),
                                         alignment=ft.Alignment(-1,1))

filter_temp_usin_column=ft.Column(controls=[filter_temp_usin_inf,filter_temp_usin_value_variability],spacing=3)
...
filter_performance_value_variability=ft.Text(value="10-1000 м³/ч",color='#ffffff',font_family='Manrope',size=15,
                          weight=ft.FontWeight.W_400)

filter_performance_cont_info=ft.Text(value="800 м³/ч",color='#ffffff',font_family='Manrope',size=30,
                          weight=ft.FontWeight.W_700)

filter_performance_cont=ft.Container(content=filter_performance_cont_info,width=131,height=40,
                                    border_radius=5, bgcolor='#00A5FF',alignment=ft.Alignment(0,-1))
filter_performance_value_variability_cont=ft.Container(content=filter_performance_cont,height=151,width=164,
                                         padding=ft.Padding(top=0,bottom=10,right=0,left=10),
                                         alignment=ft.Alignment(-1,1))

filter_performance_column=ft.Column(controls=[filter_performance_inf,filter_performance_value_variability],
                                    spacing=3)
...
srok_using_text=ft.Text(value="Срок использования",color='#ffffff',font_family='Manrope',size=15,
                          weight=ft.FontWeight.W_200)
srok_using_val=ft.Text(value="установлен 01.01.2022 (3 года)",color='#ffffff',font_family='Manrope',size=20,
                          weight=ft.FontWeight.W_500)
srok_using_column=ft.Column(controls=[srok_using_text,srok_using_val],
                            spacing=1)

filter_place_text=ft.Text(value="Место расположения",color='#ffffff',font_family='Manrope',size=15,
                          weight=ft.FontWeight.W_200)
filter_place_val=ft.Text(value="Сектор B",color='#ffffff',font_family='Manrope',size=20,
                          weight=ft.FontWeight.W_500)
filter_place_column=ft.Column(controls=[filter_place_text,filter_place_val],
                              spacing=1)

filtering_method_text=ft.Text(value="Метод очистки",color='#ffffff',font_family='Manrope',size=15,
                          weight=ft.FontWeight.W_200)
filtering_method_val=ft.Text(value="дистилляция",color='#ffffff',font_family='Manrope',size=20,
                          weight=ft.FontWeight.W_500)
